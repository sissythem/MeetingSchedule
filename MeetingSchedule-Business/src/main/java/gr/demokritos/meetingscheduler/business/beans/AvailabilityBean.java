...
public class AvailabilityBean {
    ...
    public List<AvailabilityDto> getAvailabilitiesByMeeting(Long meetingId) {
        return getAvailabilityDtos(availabilityRepository.findAvailabilityByMeeting(meetingId));
    }

    public List<AvailabilityDto> getAvailabilitiesByMeetingAndAvailability(Long meetingId, Boolean isAvailable) {
        return getAvailabilityDtos(availabilityRepository.findAvailabilityByMeetingAndAvailability(meetingId, Utilities.booleanToString(isAvailable)));
    }
