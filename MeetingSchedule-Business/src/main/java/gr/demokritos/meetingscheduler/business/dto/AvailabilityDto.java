...
public class AvailabilityDto extends ParentDto {
    ...
    public AvailabilityDto(Long id, MemberDto memberDto, DayDto dayDto, TimezoneDto timezoneDto, MeetingDto meetingDto, Boolean isAvailable) {
        super();
        this.id = id;
    ...
    public void setMeetingDto(MeetingDto meetingDto) {
        if (this.meetingDto != null) {
            this.meetingDto.internalRemoveAvailabilityDto(this);
        }
        this.meetingDto = meetingDto;
        if (meetingDto != null) {
            meetingDto.internalAddAvailabilityDto(this);
        }
    }
